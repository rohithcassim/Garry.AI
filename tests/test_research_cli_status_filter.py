"""`garry-ai-research list --status complete` was returning nothing.
...
Part of #2122 (garry-ai-* CLI list/search bugs).
"""
...
def _load_cli():
    path = ROOT / "scripts" / "garry-ai-research"
    loader = importlib.machinery.SourceFileLoader("garry-ai_research_cli", str(path))
