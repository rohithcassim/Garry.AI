...
class TaskScheduler:
    ...
    async def _deliver_via_email(self, output: str, task, result: str):
        ...
        try:
            ...
            msg["X-Garry.AI-Origin"] = "garry-ai-ui"
            msg["X-Garry.AI-Kind"] = "task"
            msg["X-Garry.AI-Ref"] = str(task.id)
    ...
    async def _deliver_via_mcp(self, tool_name: str, task, result: str):
        ...
        args = {
            ...
            "body": result,
            "headers": {
                "X-Garry.AI-Origin": "garry-ai-ui",
                "X-Garry.AI-Kind": "task",
                "X-Garry.AI-Ref": str(task.id),
            },
        }
        if recipient:
