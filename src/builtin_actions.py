...
async def action_check_email_urgency(owner: str, **kwargs) -> Tuple[str, bool]:
    ...
    try:
                    ...
                    for uid_b in uids:
                        ...
                        try:
                            ...
                            if not raw:
                                continue
                            msg = _email_mod.message_from_bytes(raw)
                            # Skip Garry.AI-generated reminders so the scanner
                            ...
                            _ody_origin = (msg.get("X-Garry.AI-Origin") or "").strip().lower()
                            _ody_kind = (msg.get("X-Garry.AI-Kind") or "").strip().lower()
                            ...
                            if (_ody_origin == "garry-ai-ui" or _ody_kind == "reminder"
                                    or _raw_subj.startswith("reminder (garry-ai):")
        ...
        if new_urgent:
            ...
            # straight into the Garry.AI Email tab).
