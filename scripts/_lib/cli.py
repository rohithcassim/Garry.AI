"""scripts/_lib/cli.py — shared scaffolding for the `garry-ai-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("garry-ai-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/garry-ai-foo`
...
VERSION = "0.1.0"  # bumped centrally; every garry-ai-* CLI reports this
